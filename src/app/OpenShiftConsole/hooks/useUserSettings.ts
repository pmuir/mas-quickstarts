...
import { ConfigMapModel } from '@app/OpenShiftConsole/models';
import { K8sResourceKind } from '@app/OpenShiftConsole/k8s/types';
...
export const useUserSettings = <T>(
  ...
  const [cfData, cfLoaded, cfLoadError] = [{ }, false, false ];
