...
const QuickStartController: React.FC<QuickStartControllerProps> = ({ quickStart }) => {
  ...
  const status = activeQuickStartState?.status as QuickStartStatus || QuickStartStatus.NOT_STARTED;
  const taskNumber = activeQuickStartState?.taskNumber as number || -1;
